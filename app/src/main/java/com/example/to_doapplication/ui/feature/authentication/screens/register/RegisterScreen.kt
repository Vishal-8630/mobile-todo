package com.example.to_doapplication.ui.feature.register
...
fun RegisterScreen(
    ...
    val fieldState by registerViewModel.registerFieldState.collectAsStateWithLifecycle()
    ...
    LaunchedEffect(uiState) {
        when(uiState.status) {
            is AuthState.Success -> {
                ...
                registerViewModel.registerFields.clearRegisterFields()
            }
            is AuthState.Error -> {
    ...
    Column(
        ...
        TextFieldComponent(
            ...
            onValueChange = { registerViewModel.registerFields.onEmailChange(it) },
            leadingIconVector = Icons.Default.Email,
            leadingIconDescription = "Email Icon",
            imeAction = ImeAction.Next,
            error = fieldState.emailError
        )
        Spacer(modifier = Modifier.height(20.dp))
        TextFieldComponent(
            value = fieldState.username,
            labelText = "Enter Username",
            onValueChange = { registerViewModel.registerFields.onUsernameChange(it) },
        ...
        TextFieldComponent(
            ...
            onValueChange = { registerViewModel.registerFields.onPasswordChange(it) },
